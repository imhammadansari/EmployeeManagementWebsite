...
const AttendanceView = () => {
    ...
    const getAttendance = async (e) => {
        ...
        try {
            const response = await axios.get(`https://employeemanagement-c46a.onrender.com/employees/viewAttendance/${employeeEmail}`);
    ...
    const deleteAttend = async (attendanceId) => {
        try {
            const response = await axios.post(`https://employeemanagement-c46a.onrender.com/employees/deleteAttendance/${attendanceId}`);
