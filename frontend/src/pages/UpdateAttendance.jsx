...
const UpdateAttendance = () => {
    ...
    useEffect(() => {
        const fetchAttendance = async () => {  
            try {  
                const response = await axios.get(`https://employeemanagement-c46a.onrender.com/employees/viewAttendanceById/${attendanceId}`);  
    ...
    const updateAttendance = async (e) => {
        ...
        try {
            const response = await axios.post(`https://employeemanagement-c46a.onrender.com/employees/updateAttendance/${attendanceId}`, {
