...
const RejectedLeaveRequests = () => {
    ...
    const getEmployees = async () => {
        try {
            const response = await axios.get("https://employeemanagementwebsite.onrender.com/employees/viewUsers");
        ...
        <>
            ...
            <div className='flex bg-slate-200 h-screen'>
                ...
                <div className="w-full my-5">
                    <h1 className='font-bold md:text-xl text-center mb-5'>Rejected Leaves</h1>
                    ...
                    {employees.map((employee) => (
                        employee.leave.filter((leaveItem) => leaveItem.status === 'Rejected').map((leaveItem, itemsIndex) => (
